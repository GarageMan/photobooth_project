...
class GalleryServiceTestCase(unittest.TestCase):
    ...
    def test_list_photos_skips_excluded_filenames(self) -> None:
        (self.photo_dir / 'mina_1.jpg').write_bytes(b'a')
        (self.photo_dir / 'testbild.png').write_bytes(b'b')
        photos = self.service.list_photos()
        self.assertEqual(len(photos), 1)
        self.assertTrue(photos[0].endswith('mina_1.jpg'))
